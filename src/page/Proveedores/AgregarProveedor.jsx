...
function AgregarProveedor() {
  ...
  <div className="proveedor-form-container">
    <h2 className="proveedor-form-title">Agregar Nuevo Proveedor</h2>
      ...
      <div className="proveedor-form-layout">
        {/* Primera columna */}
        <div className="proveedor-form-column">
          <div className="proveedor-form-field">
            <Form.Label className="proveedor-form-label required">Nombre</Form.Label>
            <Form.Control
              type="text"
              name="nombre"
          ...
          <div className="proveedor-form-field">
            <Form.Label className="proveedor-form-label required">Apellido</Form.Label>
            <Form.Control
              type="text"
              name="apellido"
        ...
        <div className="proveedor-form-column">
          <div className="proveedor-form-field">
            <Form.Label className="proveedor-form-label required">Tipo de Documento</Form.Label>
            <Form.Select
              name="tipoDocumento"
          ...
          <div className="proveedor-form-field">
            <Form.Label className="proveedor-form-label required">Documento</Form.Label>
            <Form.Control
              type="text"
              name="documento"
    ...
    <div className="proveedor-form-field flex-fill">
      ...
      />
            ...
            <div className="proveedor-form-fullwidth">
              <Form.Label className="proveedor-form-label required">Dirección</Form.Label>
            ...
            <div className="proveedor-form-fullwidth">
              <div className="proveedor-form-field">
                <Form.Label className="proveedor-form-label required">Descripción</Form.Label>
                <Form.Control
                  as="textarea"
                  rows={3}
                  name="descripcion"
            ...
            <div className="proveedor-form-actions">
              <Button variant="outline-danger" onClick={handleCancelar} className="proveedor-form-btn">
                Cancelar
              </Button>
              <Button variant="primary" onClick={handleGuardarProveedor} className="proveedor-form-btn">
                Guardar Proveedor
              </Button>
            </div>
          </div>
